...
# Kaip ir galima tikėtis, didesnė populiacija duoda geresnius rezultatus.
# Tačiau ne visada. Kartais su skirtingais L rezultatai apsiverčia.
${PRE} -a qCABC -k gens_diff_popsizes -t lin318 d198 -c 6 8 --population-sizes 20 40 80 -e 8 --capital-ls 2 --cond-y-top 5


# cores_diff_popsizes
# TODO: nebaigti testai
${PRE} -a qCABC -k cores_diff_popsizes -t lin318 d198 -c 1 2 4 6 8 --population-sizes 20 40 80 -e 8 32 --capital-ls 2


# gens_diff_cls
# L įtaka rezultatams atsitiktinė.
${PRE} -a qCABC -k gens_diff_cls -t lin318 d198 -c 6 --population-sizes 40 -e 8 --capital-ls 2 3 4
${PRE} -a qCABC -k gens_diff_cls -t eil76 -c 1 4 --population-sizes 40 -e 8 --capital-ls 2 3 4 --cond-y-top 3


# cores_diff_cls
# Vėlgi, L įtaka atsitiktinė.
${PRE} -a qCABC -k cores_diff_cls -t lin318 -c 1 2 4 6 8 --population-sizes 40 -e 8 --capital-ls 2 3 4
${PRE} -a qCABC -k cores_diff_cls -t kroA200 d198 eil76 -c 1 2 4 6 8 --population-sizes 40 -e 32 --capital-ls 2 3 4
